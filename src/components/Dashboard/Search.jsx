...
import { getAllNations, getRecipeByNation } from "../Api/nation.api";
...
function Search(props) {
  ...
  const handleSearchByTaste = (data) => {
    getRecipesByTaste(data)
      .then((res) => {
        setSearchedRecipes(res.data);
      })
      .catch((err) => {
  ...
  const handleSearchByNation = (data) => {
    getRecipeByNation(data)
      .then((res) => {
        setSearchedRecipes(res.data);
      })
      .catch((err) => {
        ...
        <div className="form-select">
          ...
          <div>
            <select
              className="country"
              id="country"
              onChange={(e) => handleSearchByNation(e.target.value)}
            >
